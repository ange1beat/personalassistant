...
async def echo_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    responder = Agent(
        ...
        backstory = "Ты ИИ ассистент который отвечает на не важные вопросы, важность сообщения тебе определяет 'classifier' агент, ты отвечаешь как 22 летний студент, увлекаешься аниме программированием и учишься в Корее, работаешь удаленно, у тебя есть девушка, веди себя как человек",
        verbose = True,
        allow_delegation = False,
        llm = llm
    )
